...
const CommentsForm = ({ slug }) => {
    ...
    return (
        <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
            ...
            <div className='grid grid-ols-1 gap-4 mb-4'>
                <textarea 
                ref={commentEl} 
            ...
            <div className='grid grid-ols-1 gap-4 mb-4'>
                <div >
                    <input ref={storeDataEl} type="checkbox" id="storeDate" name="storeData" value="true" />
            ...
            <div className='mt-8'>
                ...
                className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-indigo-500 text-lg rounded-full text-white px-8 py-3 cursor-pointer">
                    Post Comment
                </button>
